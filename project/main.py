...
def convert_side_to_gherkin(input_path: str, output_dir: str):
    ...
    try:
        ...
        output_file = os.path.join(output_dir, base_name.replace(".side", ".feature"))
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Convert Selenium .side files to Gherkin")
    parser.add_argument("-i", "--input", default="examples/login_test.side", help="Input .side file path")
    parser.add_argument("-o", "--output", default="features", help="Output directory for .feature files")
